...
def docstore():
    customer_exists = session.get('customer_exists')
    if customer_exists:
        return render_template('/Travelbuddycustomer/docstore.html',user=customer_exists)
    else:
        return render_template('/Travelbuddycustomer/login.html')

@app.route('/itenarylog')
def itenarylog():
    customer_exists = session.get('customer_exists')
    if customer_exists:
        return render_template('/Travelbuddycustomer/itenarylog.html',user=customer_exists)
    else:
        return render_template('/Travelbuddycustomer/login.html')
